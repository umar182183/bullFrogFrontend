...
{
  this.loader = true;
  this.stockService.getPartsList().subscribe((data: any) =>
  {
...
getPartNumData(partNum)
{
  ...
  this.stockService.getPartNumber(partNum).subscribe((data: any)=> {
    debugger
...
{
  this.locationDataObj = {};
  this.stockService.getLocationById(locationId, partNum).subscribe((data: any) => {
    debugger
...
{
  this.loader = true;
  this.stockService.getOpenLocationdata(bool).subscribe((data: any)=> {
    debugger
...
{
  this.stockService.assignLocation(obj).subscribe((res: any) => {
    // debugger
...
loadBuildings()
{
  this.stockService.getBuildings().subscribe((data: any) => {
    debugger
...
{
  this.stockService.getAreasByBuildingId(buildingId).subscribe((data: any) => {
    debugger
...
loadAisles(areaId)
{
  this.stockService.getAisle(areaId).subscribe((data: any) => {
    debugger
...
{
  this.stockService.getStack(areaId, aisle).subscribe((data: any) => {
    debugger
...
{
  this.stockService.getStackPosition(areaId, aisle, stack).subscribe((data: any) => {
    debugger
...
submitResults(){
  ...
  this.loader = true;
  this.stockService.editLocation(obj).subscribe((res: any) => {
    debugger
  this.loader = false;
